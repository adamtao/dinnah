...
Preferences:
{:git=>true, :railsapps=>"none", :dev_webserver=>"webrick", :database=>"mysql", :templates=>"erb", :unit_test=>"test_unit", :integration=>"none", :fixtures=>"factory_girl", :frontend=>"foundation", :email=>"smtp", :authentication=>"devise", :devise_modules=>"invitable", :authorization=>"cancan", :form_builder=>"simple_form", :starter_app=>"users_app"}
