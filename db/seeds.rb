...
Meal.create([
  ...
  {name: "Chicken Parmesan", season: "Winter"},
  ...
  {name: "Cheesy Vegetable Chowder", season: "Winter"},
  {name: "Chicken Pillows", season: "Winter"},
  {name: "Chicken pot pie", season: "Winter"},
  {name: "Roast and vegetables", season: "Winter"},
